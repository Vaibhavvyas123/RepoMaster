...
var numberOfProblemsSolved = [12,15,8,10]


function NumberOfWeeks(problems){
    let count = 0;
...
console.log("the number of weeks in which Sam met his target is ",NumberOfWeeks(numberOfProblemsSolved));
